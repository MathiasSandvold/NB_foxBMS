...
extern void FTSK_InitializeUserCodeEngine(void) {
    ...
    if (retval == 0x01U) {
        ...
        do { if (!((0u == 1u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 164); } while (0); FAS_InfiniteLoop(); } } while (0);
    }

     
    MPU_vTaskSuspend(ftsk_taskHandleAfe);
    ...
    if (retval == 0x01U) {
        ...
        do { if (!((0u == 1u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 179); } while (0); FAS_InfiniteLoop(); } } while (0);
    }
...
extern void FTSK_InitializeUserCodePreCyclicTasks(void) {
    ...
    PEX_SetPinDirectionOutput((2u), (0u));
    PEX_SetPin((2u), (0u));
    ...
    do { if (!(sys_retVal == SYS_OK)) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 221); } while (0); FAS_InfiniteLoop(); } } while (0);
...
extern void FTSK_RunUserCodeCyclic100ms(void) {
    ...
    if (ftsk_cyclic100msCounter == (10u)) {
