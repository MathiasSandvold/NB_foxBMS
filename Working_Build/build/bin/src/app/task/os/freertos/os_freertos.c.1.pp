...
void OS_StartScheduler(void) {
    ...
    do { if (!((0u == 1u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 84); } while (0); FAS_InfiniteLoop(); } } while (0);
}
...
void vApplicationGetIdleTaskMemory(
    ...
    static StackType_t os_stackSizeIdle[(( ( unsigned short ) 128 ))] = {0};
    do { if (!(ppxIdleTaskTCBBuffer != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 95); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(ppxIdleTaskStackBuffer != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 96); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pulIdleTaskStackSize != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 97); } while (0); FAS_InfiniteLoop(); } } while (0);
...
uint32_t OS_GetTickCount(void) {
    return MPU_xTaskGetTickCount();  
}

void OS_DelayTaskUntil(uint32_t *pPreviousWakeTime, uint32_t milliseconds) {
    do { if (!(pPreviousWakeTime != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 147); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(milliseconds > 0u)) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 148); } while (0); FAS_InfiniteLoop(); } } while (0);
    uint32_t ticks = (milliseconds / (( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) )));
    if ((uint32_t)ticks < 1u) {
        ticks = 1u;  
    }
    { ( void ) MPU_xTaskDelayUntil( (TickType_t *)pPreviousWakeTime, (TickType_t)ticks ); };
}
...
extern OS_STD_RETURN_e OS_WaitForNotification(uint32_t *pNotifiedValue, uint32_t timeout) {
    ...
    do { if (!(pNotifiedValue != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 162); } while (0); FAS_InfiniteLoop(); } } while (0);

    OS_STD_RETURN_e notificationReceived = OS_FAIL;
     
    
 
    BaseType_t xNotificationReceived = MPU_xTaskGenericNotifyWait( ( 0 ), ( 0xffffffffU ), ( 0xffffffffU ), ( pNotifiedValue ), ( timeout ) );
     
    if (xNotificationReceived == ( ( BaseType_t ) 1 )) {
...
extern OS_STD_RETURN_e OS_NotifyFromIsr(TaskHandle_t taskToNotify, uint32_t notifiedValue) {
    ...
    do { if (!(taskToNotify != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 178); } while (0); FAS_InfiniteLoop(); } } while (0);

    OS_STD_RETURN_e notification        = OS_FAIL;
    BaseType_t xHigherPriorityTaskWoken = ( ( BaseType_t ) 0 );
     
    BaseType_t xNotification =
        xTaskGenericNotifyFromISR( ( taskToNotify ), ( ( 0 ) ), ( notifiedValue ), ( eSetValueWithOverwrite ), ((void *)0u), ( &xHigherPriorityTaskWoken ) );
    if (xNotification == ( ( BaseType_t ) 1 )) {
...
extern OS_STD_RETURN_e OS_WaitForNotificationIndexed(
    ...
    do { if (!(pNotifiedValue != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 199); } while (0); FAS_InfiniteLoop(); } } while (0);
    ...
    BaseType_t xNotificationReceived =
        MPU_xTaskGenericNotifyWait( ( indexToWaitOn ), ( 0xffffffffU ), ( 0xffffffffU ), ( pNotifiedValue ), ( timeout ) );
...
extern OS_STD_RETURN_e OS_NotifyIndexedFromIsr(
    ...
    do { if (!(taskToNotify != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 219); } while (0); FAS_InfiniteLoop(); } } while (0);

    OS_STD_RETURN_e notification        = OS_FAIL;
    BaseType_t xHigherPriorityTaskWoken = ( ( BaseType_t ) 0 );
     
    BaseType_t xNotification = xTaskGenericNotifyFromISR( ( taskToNotify ), ( indexToNotify ), ( notifiedValue ), ( eSetValueWithOverwrite ), ((void *)0u), ( &xHigherPriorityTaskWoken ) );
    if (xNotification == ( ( BaseType_t ) 1 )) {
        notification = OS_SUCCESS;
    }
...
extern OS_STD_RETURN_e OS_ClearNotificationIndexed(uint32_t indexToClear) {
    ...
    BaseType_t xNotificationWasPending = MPU_xTaskGenericNotifyStateClear( ( ((void *)0u) ), ( indexToClear ) );
     
    if (xNotificationWasPending == ( ( BaseType_t ) 1 )) {
...
extern OS_STD_RETURN_e OS_ReceiveFromQueue(QueueHandle_t xQueue, void *const pvBuffer, uint32_t ticksToWait) {
    do { if (!(pvBuffer != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 249); } while (0); FAS_InfiniteLoop(); } } while (0);

    OS_STD_RETURN_e queueReceiveSuccessfully = OS_FAIL;
     
    BaseType_t xQueueReceiveSuccess = MPU_xQueueReceive(xQueue, pvBuffer, (TickType_t)ticksToWait);
     
    if (xQueueReceiveSuccess == ( ( BaseType_t ) 1 )) {
...
extern OS_STD_RETURN_e OS_SendToBackOfQueue(QueueHandle_t xQueue, const void *const pvItemToQueue, uint32_t ticksToWait) {
    do { if (!(pvItemToQueue != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 262); } while (0); FAS_InfiniteLoop(); } } while (0);

    OS_STD_RETURN_e queueSendSuccessfully = OS_FAIL;
    BaseType_t xQueueSendSuccess          = MPU_xQueueGenericSend( ( xQueue ), ( pvItemToQueue ), ( (TickType_t)ticksToWait ), ( ( BaseType_t ) 0 ) );
     
    if (xQueueSendSuccess == ( ( BaseType_t ) 1 )) {
...
extern OS_STD_RETURN_e OS_SendToBackOfQueueFromIsr(
    ...
    const void *const pvItemToQueue,
    long *const pxHigherPriorityTaskWoken) {
    do { if (!(pvItemToQueue != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 277); } while (0); FAS_InfiniteLoop(); } } while (0);

    OS_STD_RETURN_e queueSendSuccessfully = OS_FAIL;
    BaseType_t xQueueSendSuccess =
        xQueueGenericSendFromISR( ( xQueue ), ( pvItemToQueue ), ( (BaseType_t *)pxHigherPriorityTaskWoken ), ( ( BaseType_t ) 0 ) );
...
extern uint32_t OS_GetNumberOfStoredMessagesInQueue(QueueHandle_t xQueue) {
    long numberOfMessages = MPU_uxQueueMessagesWaiting(xQueue);
