...
extern int16_t TS_Mur00GetTemperatureFromLut(uint16_t adcVoltage_mV) {
    int16_t temperature_ddegC = (-0x7fff-1);
    float_t adcVoltage_V      = (float_t)adcVoltage_mV / (1000.0f);  

     
    if (adcVoltage_V > ((float_t)(((3.3f) * ts_ncu15xh103f6sxxLut[0u]. resistance_Ohm) / (ts_ncu15xh103f6sxxLut[0u]. resistance_Ohm+(10000.0f))))) {
         
        temperature_ddegC = (-0x7fff-1);
    } else if (adcVoltage_V < ((float_t)(((3.3f) * ts_ncu15xh103f6sxxLut[ts_ncu15xh103f6sxxLutSize - 1u]. resistance_Ohm) / (ts_ncu15xh103f6sxxLut[ts_ncu15xh103f6sxxLutSize - 1u]. resistance_Ohm+(10000.0f))))) {
        ...
        const float_t resistance_Ohm =
            (10000.0f) *
            (adcVoltage_V / ((3.3f) - adcVoltage_V));
        ...
        if (!(((between_high == 0u) && (between_low == 0u)) ||  
              (between_low >= ts_ncu15xh103f6sxxLutSize))) {    
...
extern int16_t TS_Mur00GetTemperatureFromPolynomial(uint16_t adcVoltage_mV) {
    (void)adcVoltage_mV;
    do { if (!((0u == 1u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 169); } while (0); FAS_InfiniteLoop(); } } while (0);
