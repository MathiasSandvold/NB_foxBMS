...
extern int16_t TS_Epc00GetTemperatureFromLut(uint16_t adcVoltage_mV) {
    ...
    if (adcVoltage_V > ((float_t)(((2.5f) * ts_b57251v5103j060Lut[0]. resistance_Ohm) / (ts_b57251v5103j060Lut[0]. resistance_Ohm+(10000.0f))))) {
         
        temperature_ddegC = (-0x7fff-1);
    } else if (adcVoltage_V < ((float_t)(((2.5f) * ts_b57251v5103j060Lut[b57251v5103j060LutSize - 1]. resistance_Ohm) / (ts_b57251v5103j060Lut[b57251v5103j060LutSize - 1]. resistance_Ohm+(10000.0f))))) {
        ...
        resistance_Ohm = (10000.0f) *
                         (adcVoltage_V / ((2.5f) - adcVoltage_V));
        ...
        if (!(((between_high == 0u) && (between_low == 0u)) ||  
              (between_low > b57251v5103j060LutSize))) {        
...
extern int16_t TS_Epc00GetTemperatureFromPolynomial(uint16_t adcVoltage_mV) {
    ...
    return (int16_t)(temperature_degC * 10.0f);  
}
