...
static void ILCK_InitializePins(void) {
    ...
    IO_SetPinDirectionToOutput(&(((hetBASE_t *)0xFFF7B800U)->DIR), (30u));
     
    IO_PinReset(&(((hetBASE_t *)0xFFF7B800U))->DOUT, (30u));
     
    IO_SetPinDirectionToInput(&(((hetBASE_t *)0xFFF7B800U)->DIR), (29u));
}
...
static ILCK_ELECTRICAL_STATE_TYPE_e ILCK_GetInterlockFeedback(void) {
    ...
    OS_EnterTaskCritical();
    const STD_PIN_STATE_e pinState = IO_PinGet(&(((hetBASE_t *)0xFFF7B800U))->DIN, (29u));
    OS_ExitTaskCritical();

     
    DATA_BLOCK_ADC_VOLTAGE_s ilck_tableAdcVoltages = {.header.uniqueId = DATA_BLOCK_ID_ADC_VOLTAGE};
    (DATA_Read1DataBlock) (&ilck_tableAdcVoltages);
    ...
    ilck_tableFeedback.interlockVoltageFeedback_IL_HS_VS_mV =
        ilck_tableAdcVoltages.adc1ConvertedVoltages_mV[(2u)] *
        ((5.6f + 3.9f) / 3.9f);
    ilck_tableFeedback.interlockVoltageFeedback_IL_LS_VS_mV =
        ilck_tableAdcVoltages.adc1ConvertedVoltages_mV[(3u)] *
        ((5.6f + 3.9f) / 3.9f);
    ilck_tableFeedback.interlockCurrentFeedback_IL_HS_CS_mA =
        ilck_tableAdcVoltages.adc1ConvertedVoltages_mV[(4u)] *
        (80.0f / 2049.0f);
    ilck_tableFeedback.interlockCurrentFeedback_IL_LS_CS_mA =
        ilck_tableAdcVoltages.adc1ConvertedVoltages_mV[(5u)] *
        (0.025f);

    ilck_tableFeedback.interlockFeedback_IL_STATE = measuredInterlockState;

    (DATA_Write1DataBlock) (&ilck_tableFeedback);
...
void ILCK_Trigger(void) {
    ...
    switch (ilck_state.state) {
        ...
        case ILCK_STATEMACHINE_UNINITIALIZED:
            ...
            if (statereq == ILCK_STATE_INITIALIZATION_REQUEST) {
                ilck_state . laststate = ilck_state . state; ilck_state . lastsubstate = ilck_state . substate;
                ILCK_InitializePins();
                ilck_state.timer    = (1u);
        ...
        default:
            ...
            do { if (!((0u == 1u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 316); } while (0); FAS_InfiniteLoop(); } } while (0);
            break;
    }  
