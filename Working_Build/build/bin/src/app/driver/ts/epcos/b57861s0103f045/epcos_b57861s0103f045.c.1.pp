...
extern int16_t TS_Epc01GetTemperatureFromLut(uint16_t adcVoltage_mV) {
    ...
    if (adcVoltage_V > ((float_t)(((3.0f) * ts_b57861s0103f045Lut[0]. resistance_Ohm) / (ts_b57861s0103f045Lut[0]. resistance_Ohm+(10000.0f))))) {
         
        temperature_ddegC = (-0x7fff-1);
    } else if (adcVoltage_V < ((float_t)(((3.0f) * ts_b57861s0103f045Lut[ts_b57861s0103f045LutSize - 1]. resistance_Ohm) / (ts_b57861s0103f045Lut[ts_b57861s0103f045LutSize - 1]. resistance_Ohm+(10000.0f))))) {
        ...
        if (!(((between_high == 0u) && (between_low == 0u)) ||  
              (between_low >= ts_b57861s0103f045LutSize))) {    
