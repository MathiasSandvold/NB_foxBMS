...
void Dp83640Reset(uint32 mdioBaseAddr, uint32 phyAddr)
{
	...
	MDIOPhyRegWrite(mdioBaseAddr, phyAddr, (0u), (0x8000U));

	(void)MDIOPhyRegRead(mdioBaseAddr, phyAddr, (0u), regPtr);
	 
	while((regVal & (0x8000U)) != 0U)
	{
		(void)MDIOPhyRegRead(mdioBaseAddr, phyAddr, (0u), regPtr);
	}
}
...
void Dp83640EnableLoopback(uint32 mdioBaseAddr, uint32 phyAddr)
{
	...
	uint16 *regPtr = &regVal;
	(void)MDIOPhyRegRead(mdioBaseAddr, phyAddr, (uint32)(0u), regPtr);
