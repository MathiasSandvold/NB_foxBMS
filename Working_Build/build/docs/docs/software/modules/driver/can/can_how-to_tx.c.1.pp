...
typedef struct {
    ...
    DATA_BLOCK_HEADER_s header;                                  
    float_t adc1ConvertedVoltages_mV[1];  
...
const CAN_TX_MESSAGE_TYPE_s can_txMessages[] = {
    ...
    {((CAN_NODE_s *)&can_node1), { . dlc = (8u), . id = (0x220u), . endianness = (CAN_BIG_ENDIAN), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), }, { . period = (100u), . phase = (0u) }, &CANTX_BmsState, ((void *)(0u))},  
};
