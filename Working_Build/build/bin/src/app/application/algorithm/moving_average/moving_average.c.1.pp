...
static float_t  curValues[(60000u / (200u)) + 1u] = {0.0f};
static uint32_t movingAverageCurrentLength = (60000u / (200u)) + 1u;

 
 
static float_t  powValues[(60000u / (200u)) + 1u] = {0.0f};
static uint32_t movingAveragePowerLength = (60000u / (200u)) + 1u;
...
extern void ALGO_MovAverage(void) {
    ...
    static uint8_t curInit   = 0u;  
    static uint8_t powInit   = 0u;  
    static uint8_t newValues = 0u;
    float_t divider          = 0.0f;
    _Bool validValues         = 1;

    (DATA_Read1DataBlock) (&curPow_tab);
    (DATA_Read1DataBlock) (&movingAverage_tab);
        ...
        if (validValues == 1) {
            ...
            *pMovingAverageCurrentNew = packCurrent;
            ...
            if ((curInit & 0x01u) == 0x01u) {
                ...
                if (pMovingAverageCurrentNew == &curValues[((1000u) / (200u))]) {
                    curInit |= 0x01u;
                }
            }
            if ((curInit & 0x02u) == 0x02u) {
                ...
                if (pMovingAverageCurrentNew == &curValues[((5000u) / (200u))]) {
                    curInit |= 0x02u;
                }
            }
            if ((curInit & 0x04u) == 0x04u) {
                ...
                if (pMovingAverageCurrentNew == &curValues[((10000u) / (200u))]) {
                    curInit |= 0x04u;
                }
            }
            if ((curInit & 0x08u) == 0x08u) {
                ...
                if (pMovingAverageCurrentNew == &curValues[((30000u) / (200u))]) {
                    curInit |= 0x08u;
                }
            }
            if ((curInit & 0x10u) == 0x10u) {
                ...
                if (pMovingAverageCurrentNew == &curValues[((60000u) / (200u))]) {
                    curInit |= 0x10u;
                }
            }
            if ((curInit & 0x20u) == 0x20u) {
                ...
                if (pMovingAverageCurrentNew == &curValues[((3000u) / (200u))]) {
                    curInit |= 0x20u;
                }
            }
        ...
        if (validValues == 1) {
            ...
            *pMovingAveragePowerNew = packPower;
            ...
            if ((powInit & 0x01u) == 0x01u) {
                ...
                if (pMovingAveragePowerNew == &powValues[((1000u) / (200u))]) {
                    powInit |= 0x01u;
                }
            }
            if ((powInit & 0x02u) == 0x02u) {
                ...
                if (pMovingAveragePowerNew == &powValues[((5000u) / (200u))]) {
                    powInit |= 0x02u;
                }
            }
            if ((powInit & 0x04u) == 0x04u) {
                ...
                if (pMovingAveragePowerNew == &powValues[((10000u) / (200u))]) {
                    powInit |= 0x04u;
                }
            }
            if ((powInit & 0x08u) == 0x08u) {
                ...
                if (pMovingAveragePowerNew == &powValues[((30000u) / (200u))]) {
                    powInit |= 0x08u;
                }
            }
            if ((powInit & 0x10u) == 0x10u) {
                ...
                if (pMovingAveragePowerNew == &powValues[((60000u) / (200u))]) {
                    powInit |= 0x10u;
                }
            }
            if ((powInit & 0x20u) == 0x20u) {
                ...
                if (pMovingAveragePowerNew == &powValues[((3000u) / (200u))]) {
                    powInit |= 0x20u;
                }
            }
    ...
    if (newValues == 1u) {
        ...
        (DATA_Write1DataBlock) (&movingAverage_tab);
    }
}
