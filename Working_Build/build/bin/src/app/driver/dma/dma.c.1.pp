...
void DMA_Initialize(void) {
    ...
    g_dmaCTRL dma_controlPacketSpiTx = {
        ...
        .FRDOFFSET = 0u,                                
        .FRSOFFSET = 0u,                                
        .PORTASGN  = (uint32_t)PORTA_READ_PORTB_WRITE,  
        .RDSIZE    = (uint32_t)ACCESS_16_BIT,           
        .WRSIZE    = (uint32_t)ACCESS_16_BIT,           
        .TTYPE     = (uint32_t)FRAME_TRANSFER,          
        .ADDMODERD = (uint32_t)ADDR_INC1,               
        .ADDMODEWR = (uint32_t)ADDR_FIXED,              
        .AUTOINIT  = (uint32_t)AUTOINIT_OFF             
    };
    ...
    g_dmaCTRL dma_controlPacketSpiRx = {
        ...
        .FRDOFFSET = 0u,                                
        .FRSOFFSET = 0u,                                
        .PORTASGN  = (uint32_t)PORTB_READ_PORTA_WRITE,  
        .RDSIZE    = ACCESS_16_BIT,                     
        .WRSIZE    = ACCESS_16_BIT,                     
    ...
    g_dmaCTRL dma_controlPacketI2cTx = {
        ...
        .FRSOFFSET = 0u,                                
        .PORTASGN  = (uint32_t)PORTA_READ_PORTB_WRITE,  
        .RDSIZE    = (uint32_t)ACCESS_8_BIT,            
        .WRSIZE    = (uint32_t)ACCESS_8_BIT,            
        .TTYPE     = (uint32_t)FRAME_TRANSFER,          
        .ADDMODERD = (uint32_t)ADDR_INC1,               
        .ADDMODEWR = (uint32_t)ADDR_FIXED,              
        .AUTOINIT  = (uint32_t)AUTOINIT_OFF             
    ...
    g_dmaCTRL dma_controlPacketI2cRx = {
        ...
        .WRSIZE    = (uint32_t)ACCESS_8_BIT,            
        .TTYPE     = (uint32_t)FRAME_TRANSFER,          
        .ADDMODERD = (uint32_t)ADDR_FIXED,              
        .ADDMODEWR = (uint32_t)ADDR_INC1,               
        .AUTOINIT  = (uint32_t)AUTOINIT_OFF             
    };
    ...
    for (uint8_t i = 0u; i < (5u); i++) {
        ...
        if (1 || i != SPI_GetSpiIndex(((spiBASE_t *)0xFFF7FA00U))) {
            dmaEnableInterrupt(
        ...
        dma_controlPacketSpiTx.DADD = (uint32_t)(&(dma_spiInterfaces[i]->DAT1)) + (2u);
        dma_controlPacketSpiRx.SADD = (uint32_t)(&(dma_spiInterfaces[i]->BUF)) + (2u);
    ...
    dmaReqAssign((dmaChannel_t)(DMA_CH10), (dmaRequest_t)(DMA_REQ11));
     
    dmaReqAssign((dmaChannel_t)(DMA_CH11), (dmaRequest_t)(DMA_REQ10));

    

 
    dmaEnableInterrupt((dmaChannel_t)(dmaChannel_t)(DMA_CH10), (dmaInterrupt_t)BTC, (dmaIntGroup_t)DMA_INTA);
    dmaEnableInterrupt((dmaChannel_t)(dmaChannel_t)(DMA_CH11), (dmaInterrupt_t)BTC, (dmaIntGroup_t)DMA_INTA);
    dmaEnableInterrupt((dmaChannel_t)(dmaChannel_t)(DMA_CH11), (dmaInterrupt_t)LFS, (dmaIntGroup_t)DMA_INTA);

    dma_controlPacketI2cTx.DADD = (uint32_t)(&(((i2cBASE_t *)0xFFF7D400U)->DXR)) + (3u);
    dma_controlPacketI2cRx.SADD = (uint32_t)(&(((i2cBASE_t *)0xFFF7D400U)->DRR)) + (3u);

     
    dmaSetCtrlPacket((dmaChannel_t)(DMA_CH10), dma_controlPacketI2cTx);

     
    dmaSetCtrlPacket((dmaChannel_t)(DMA_CH11), dma_controlPacketI2cRx);

     
    dmaSetChEnable((dmaChannel_t)(DMA_CH10), (dmaTriggerType_t)DMA_HW);
    dmaSetChEnable((dmaChannel_t)(DMA_CH11), (dmaTriggerType_t)DMA_HW);

     

     
    dmaReqAssign((dmaChannel_t)(DMA_CH12), (dmaRequest_t)(DMA_REQ33));
     
    dmaReqAssign((dmaChannel_t)(DMA_CH13), (dmaRequest_t)(DMA_REQ32));

    

 
    dmaEnableInterrupt((dmaChannel_t)(dmaChannel_t)(DMA_CH12), (dmaInterrupt_t)BTC, (dmaIntGroup_t)DMA_INTA);
    dmaEnableInterrupt((dmaChannel_t)(dmaChannel_t)(DMA_CH13), (dmaInterrupt_t)BTC, (dmaIntGroup_t)DMA_INTA);
    dmaEnableInterrupt((dmaChannel_t)(dmaChannel_t)(DMA_CH13), (dmaInterrupt_t)LFS, (dmaIntGroup_t)DMA_INTA);

    dma_controlPacketI2cTx.DADD = (uint32_t)(&(((i2cBASE_t *)0xFFF7D500U)->DXR)) + (3u);
    dma_controlPacketI2cRx.SADD = (uint32_t)(&(((i2cBASE_t *)0xFFF7D500U)->DRR)) + (3u);

     
    dmaSetCtrlPacket((dmaChannel_t)(DMA_CH12), dma_controlPacketI2cTx);

     
    dmaSetCtrlPacket((dmaChannel_t)(DMA_CH13), dma_controlPacketI2cRx);

     
    dmaSetChEnable((dmaChannel_t)(DMA_CH12), (dmaTriggerType_t)DMA_HW);
    dmaSetChEnable((dmaChannel_t)(DMA_CH13), (dmaTriggerType_t)DMA_HW);
}
    ...
    if (inttype == (dmaInterrupt_t)BTC) {
        ...
        switch (channel) {
            ...
            case (DMA_CH8):
                ...
                timeoutIterations = (6000u);
                 
                while (((dma_spiInterfaces[spiIndex]->FLG &
                         (uint32)((uint32_t)1u << (9u))) == 0u) &&
            ...
            case (DMA_CH9):
                ...
                if (0 && spiIndex == SPI_GetSpiIndex(((spiBASE_t *)0xFFF7FA00U))) {  
                     
                    dma_spiInterfaces[spiIndex]->INT0 &= ~(0x10000u);
                     
                    dma_spiInterfaces[spiIndex]->GCR1 &= ~(0x1000000u);
                     
                    dma_spiInterfaces[spiIndex]->PC0 &= (0xFFFFFF00u);
                    ...
                    if (spiIndex == SPI_GetSpiIndex(((spiBASE_t *)0xFFF7FA00U))) {
                        AFE_DmaCallback(spiIndex);
                    }
            ...
            case (DMA_CH10):
                ((i2cBASE_t *)0xFFF7D400U)->DMACR &= ~((uint32_t)(0x2u));
                (void)xTaskGenericNotifyFromISR( ( (ftsk_taskHandleI2c) ), ( (1u) ), ( (0x51u) ), ( eSetValueWithOverwrite ), ((void *)0u), ( &xHigherPriorityTaskWoken ) );
                do { if( xHigherPriorityTaskWoken != ( ( BaseType_t ) 0 ) ) { ( *( ( volatile uint32_t * ) 0xFFFFFFB0 ) ) = ( 0x7500UL ); ( void ) ( *( ( volatile uint32_t * ) 0xFFFFFFB0 ) ); } } while( 0 );
                break;
            case (DMA_CH12):
                ((i2cBASE_t *)0xFFF7D500U)->DMACR &= ~((uint32_t)(0x2u));
                (void)xTaskGenericNotifyFromISR( ( (ftsk_taskHandleI2c) ), ( (1u) ), ( (0x51u) ), ( eSetValueWithOverwrite ), ((void *)0u), ( &xHigherPriorityTaskWoken ) );
                do { if( xHigherPriorityTaskWoken != ( ( BaseType_t ) 0 ) ) { ( *( ( volatile uint32_t * ) 0xFFFFFFB0 ) ) = ( 0x7500UL ); ( void ) ( *( ( volatile uint32_t * ) 0xFFFFFFB0 ) ); } } while( 0 );
                break;
            ...
            case (DMA_CH11):
                ((i2cBASE_t *)0xFFF7D400U)->DMACR &= ~((uint32_t)(0x1u));
                 
                success = I2C_WaitReceive(((i2cBASE_t *)0xFFF7D400U), (1000u));
                if (success == 0) {
                     
                    ((i2cBASE_t *)0xFFF7D400U)->MDR |= (uint32_t)I2C_REPEATMODE;
                    i2cSetStop(((i2cBASE_t *)0xFFF7D400U));
                    (void)xTaskGenericNotifyFromISR( ( (ftsk_taskHandleI2c) ), ( (2u) ), ( (0x62u) ), ( eSetValueWithOverwrite ), ((void *)0u), ( &xHigherPriorityTaskWoken ) );
                    do { if( xHigherPriorityTaskWoken != ( ( BaseType_t ) 0 ) ) { ( *( ( volatile uint32_t * ) 0xFFFFFFB0 ) ) = ( 0x7500UL ); ( void ) ( *( ( volatile uint32_t * ) 0xFFFFFFB0 ) ); } } while( 0 );
                } else {
                    i2c_rxLastByteInterface1 = I2C_ReadLastRxByte(((i2cBASE_t *)0xFFF7D400U));
                    (void)xTaskGenericNotifyFromISR( ( (ftsk_taskHandleI2c) ), ( (2u) ), ( (0x61u) ), ( eSetValueWithOverwrite ), ((void *)0u), ( &xHigherPriorityTaskWoken ) );
                    do { if( xHigherPriorityTaskWoken != ( ( BaseType_t ) 0 ) ) { ( *( ( volatile uint32_t * ) 0xFFFFFFB0 ) ) = ( 0x7500UL ); ( void ) ( *( ( volatile uint32_t * ) 0xFFFFFFB0 ) ); } } while( 0 );
                }
                break;
            case (DMA_CH13):
                ((i2cBASE_t *)0xFFF7D500U)->DMACR &= ~((uint32_t)(0x1u));
                 
                success = I2C_WaitReceive(((i2cBASE_t *)0xFFF7D500U), (1000u));
                if (success == 0) {
                     
                    ((i2cBASE_t *)0xFFF7D500U)->MDR |= (uint32_t)I2C_REPEATMODE;
                    i2cSetStop(((i2cBASE_t *)0xFFF7D500U));
                    (void)xTaskGenericNotifyFromISR( ( (ftsk_taskHandleI2c) ), ( (2u) ), ( (0x62u) ), ( eSetValueWithOverwrite ), ((void *)0u), ( &xHigherPriorityTaskWoken ) );
                    do { if( xHigherPriorityTaskWoken != ( ( BaseType_t ) 0 ) ) { ( *( ( volatile uint32_t * ) 0xFFFFFFB0 ) ) = ( 0x7500UL ); ( void ) ( *( ( volatile uint32_t * ) 0xFFFFFFB0 ) ); } } while( 0 );
                } else {
                    i2c_rxLastByteInterface2 = I2C_ReadLastRxByte(((i2cBASE_t *)0xFFF7D500U));
                    (void)xTaskGenericNotifyFromISR( ( (ftsk_taskHandleI2c) ), ( (2u) ), ( (0x61u) ), ( eSetValueWithOverwrite ), ((void *)0u), ( &xHigherPriorityTaskWoken ) );
                    do { if( xHigherPriorityTaskWoken != ( ( BaseType_t ) 0 ) ) { ( *( ( volatile uint32_t * ) 0xFFFFFFB0 ) ) = ( 0x7500UL ); ( void ) ( *( ( volatile uint32_t * ) 0xFFFFFFB0 ) ); } } while( 0 );
                }
                break;
