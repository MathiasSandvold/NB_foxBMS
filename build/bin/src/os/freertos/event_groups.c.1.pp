...
static BaseType_t prvTestWaitCondition( const EventBits_t uxCurrentEventBits,
                                        const EventBits_t uxBitsToWaitFor,
                                        const BaseType_t xWaitForAllBits ) __attribute__( ( section( ".kernelTEXT" ) ) );
    ...
    EventGroupHandle_t xEventGroupCreateStatic( StaticEventGroup_t * pxEventGroupBuffer )
    {
        ...
        if( ( pxEventGroupBuffer ) == ( ( BaseType_t ) 0 ) ) { vPortDisableInterrupts(); for( ; ; ) {; } };

            {
                ...
                if( ( xSize == sizeof( EventGroup_t ) ) == ( ( BaseType_t ) 0 ) ) { vPortDisableInterrupts(); for( ; ; ) {; } };
            }  
...
void vEventGroupDelete( EventGroupHandle_t xEventGroup )
{
    ...
    if( ( pxEventBits ) == ( ( BaseType_t ) 0 ) ) { vPortDisableInterrupts(); for( ; ; ) {; } };
    ...
    vTaskSuspendAll();
    {
        ...
        while( ( ( pxTasksWaitingForBits )->uxNumberOfItems ) > ( UBaseType_t ) 0 )
        {
            ...
            if( ( pxTasksWaitingForBits->xListEnd . pxNext != ( const ListItem_t * ) &( pxTasksWaitingForBits->xListEnd ) ) == ( ( BaseType_t ) 0 ) ) { vPortDisableInterrupts(); for( ; ; ) {; } };
