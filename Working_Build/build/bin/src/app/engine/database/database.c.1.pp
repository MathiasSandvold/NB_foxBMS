...
_Static_assert(((10u) / (( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) ))) > 0u, "invalid database queue timeout!");
...
static STD_RETURN_TYPE_e DATA_AccessDatabaseEntries(
    ...
    void *pData2,
    void *pData3) {
    do { if (!((accessType == DATA_WRITE_ACCESS) || (accessType == DATA_READ_ACCESS))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 137); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pData0 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 138); } while (0); FAS_InfiniteLoop(); } } while (0);
    ...
    DATA_QUEUE_MESSAGE_s data_sendMessage = {
        .pDatabaseEntry[(0u)] = pData0,
        .pDatabaseEntry[(1u)] = pData1,
        .pDatabaseEntry[(2u)] = pData2,
        .pDatabaseEntry[(3u)] = pData3,
        .accessType                   = accessType,
    };
     
    if (OS_SendToBackOfQueue(ftsk_databaseQueue, (void *)&data_sendMessage, ((10u) / (( ( TickType_t ) 1000 / ( ( TickType_t ) 1000 ) )))) == OS_SUCCESS) {
        retval = STD_OK;
    }
    return retval;
}
...
static void DATA_CopyData(
    ...
    void *pDatabaseStruct,
    void *pPassedDataStruct) {
    do { if (!((accessType == DATA_WRITE_ACCESS) || (accessType == DATA_READ_ACCESS))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 170); } while (0); FAS_InfiniteLoop(); } } while (0);
     
     
    do { if (!(pDatabaseStruct != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 173); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pPassedDataStruct != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 174); } while (0); FAS_InfiniteLoop(); } } while (0);
    ...
    if (accessType == DATA_WRITE_ACCESS) {
        ...
        do { if (!((0u == 1u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 195); } while (0); FAS_InfiniteLoop(); } } while (0);
    }
}

static void DATA_IterateOverDatabaseEntries(const DATA_QUEUE_MESSAGE_s *kpReceiveMessage) {
    do { if (!(kpReceiveMessage != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 200); } while (0); FAS_InfiniteLoop(); } } while (0);
    for (uint8_t queueEntry = 0u; queueEntry < (4u); queueEntry++) {
        



 
        if (kpReceiveMessage->pDatabaseEntry[queueEntry] != ((void *)(0u))) {
            ...
            do { if (!(uniqueId < (uint8_t)DATA_BLOCK_ID_MAX)) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 216); } while (0); FAS_InfiniteLoop(); } } while (0);
...
STD_RETURN_TYPE_e DATA_Initialize(void) {
    ...
    const _Bool allQueuesCreatedCopyForAssert = ftsk_allQueuesCreated;
    do { if (!(allQueuesCreatedCopyForAssert == 1)) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 233); } while (0); FAS_InfiniteLoop(); } } while (0);

    _Static_assert((sizeof(data_database) != 0u), "No database defined");
    
 
    _Static_assert(((sizeof(data_database) / sizeof(DATA_BASE_s)) == (uint8_t)(DATA_BLOCK_ID_MAX)), "Database array length error");
    ...
    for (uint8_t databaseEntry = 0u; databaseEntry < data_baseHeader.nrDatabaseEntries; databaseEntry++) {
        ...
        do { if (!(pHeader != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 261); } while (0); FAS_InfiniteLoop(); } } while (0);
...
void DATA_Task(void) {
    if (ftsk_databaseQueue != ((void *)(0u))) {
        DATA_QUEUE_MESSAGE_s receiveMessage = {
            ...
            .pDatabaseEntry = {(((void *)(0u))), (((void *)(0u))), (((void *)(0u))), (((void *)(0u)))}};
        ...
        if (OS_ReceiveFromQueue(ftsk_databaseQueue, (&receiveMessage), 1u) == OS_SUCCESS) {
            ...
            do { if (!(receiveMessage . pDatabaseEntry[0] != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 290); } while (0); FAS_InfiniteLoop(); } } while (0);
...
STD_RETURN_TYPE_e DATA_Read1DataBlock(void *pDataToReceiver0) {
    do { if (!(pDataToReceiver0 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 301); } while (0); FAS_InfiniteLoop(); } } while (0);
    return DATA_AccessDatabaseEntries(DATA_READ_ACCESS, pDataToReceiver0, ((void *)(0u)), ((void *)(0u)), ((void *)(0u)));
}

STD_RETURN_TYPE_e DATA_Read2DataBlocks(void *pDataToReceiver0, void *pDataToReceiver1) {
    do { if (!(pDataToReceiver0 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 306); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pDataToReceiver1 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 307); } while (0); FAS_InfiniteLoop(); } } while (0);
    return DATA_AccessDatabaseEntries(DATA_READ_ACCESS, pDataToReceiver0, pDataToReceiver1, ((void *)(0u)), ((void *)(0u)));
}

STD_RETURN_TYPE_e DATA_Read3DataBlocks(void *pDataToReceiver0, void *pDataToReceiver1, void *pDataToReceiver2) {
    do { if (!(pDataToReceiver0 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 312); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pDataToReceiver1 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 313); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pDataToReceiver2 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 314); } while (0); FAS_InfiniteLoop(); } } while (0);
    return DATA_AccessDatabaseEntries(DATA_READ_ACCESS, pDataToReceiver0, pDataToReceiver1, pDataToReceiver2, ((void *)(0u)));
}
...
STD_RETURN_TYPE_e DATA_Read4DataBlocks(
    ...
    void *pDataToReceiver2,
    void *pDataToReceiver3) {
    do { if (!(pDataToReceiver0 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 323); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pDataToReceiver1 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 324); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pDataToReceiver2 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 325); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pDataToReceiver3 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 326); } while (0); FAS_InfiniteLoop(); } } while (0);
...
STD_RETURN_TYPE_e DATA_Write1DataBlock(void *pDataFromSender0) {
    do { if (!(pDataFromSender0 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 332); } while (0); FAS_InfiniteLoop(); } } while (0);
    return DATA_AccessDatabaseEntries(DATA_WRITE_ACCESS, pDataFromSender0, ((void *)(0u)), ((void *)(0u)), ((void *)(0u)));
}

STD_RETURN_TYPE_e DATA_Write2DataBlocks(void *pDataFromSender0, void *pDataFromSender1) {
    do { if (!(pDataFromSender0 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 337); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pDataFromSender1 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 338); } while (0); FAS_InfiniteLoop(); } } while (0);
    return DATA_AccessDatabaseEntries(DATA_WRITE_ACCESS, pDataFromSender0, pDataFromSender1, ((void *)(0u)), ((void *)(0u)));
}

STD_RETURN_TYPE_e DATA_Write3DataBlocks(void *pDataFromSender0, void *pDataFromSender1, void *pDataFromSender2) {
    do { if (!(pDataFromSender0 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 343); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pDataFromSender1 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 344); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pDataFromSender2 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 345); } while (0); FAS_InfiniteLoop(); } } while (0);
    return DATA_AccessDatabaseEntries(
        DATA_WRITE_ACCESS, pDataFromSender0, pDataFromSender1, pDataFromSender2, ((void *)(0u)));
}
...
STD_RETURN_TYPE_e DATA_Write4DataBlocks(
    ...
    void *pDataFromSender2,
    void *pDataFromSender3) {
    do { if (!(pDataFromSender0 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 355); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pDataFromSender1 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 356); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pDataFromSender2 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 357); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pDataFromSender3 != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 358); } while (0); FAS_InfiniteLoop(); } } while (0);
    return DATA_AccessDatabaseEntries(
...
extern void DATA_ExecuteDataBist(void) {
    ...
    dummyWriteTable.member1                          = 0xff;
    dummyWriteTable.member2                          = ((uint8_t)0xAAu);

     
    STD_RETURN_TYPE_e writeReturnValue = (DATA_Write1DataBlock) (&dummyWriteTable);
    do { if (!(writeReturnValue == STD_OK)) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 371); } while (0); FAS_InfiniteLoop(); } } while (0);

    DATA_BLOCK_DUMMY_FOR_SELF_TEST_s dummyReadTable = {.header.uniqueId = DATA_BLOCK_ID_DUMMY_FOR_SELF_TEST};

     
    STD_RETURN_TYPE_e readReturnValue = (DATA_Read1DataBlock) (&dummyReadTable);
    do { if (!(readReturnValue == STD_OK)) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 377); } while (0); FAS_InfiniteLoop(); } } while (0);

    do { if (!(dummyReadTable . member1 == dummyWriteTable . member1)) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 379); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(dummyReadTable . member2 == dummyWriteTable . member2)) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 380); } while (0); FAS_InfiniteLoop(); } } while (0);
}
