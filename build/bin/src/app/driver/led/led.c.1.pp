...
extern void LED_SetDebugLed(void) {
    IO_PinSet(&(((hetBASE_t *)0xFFF7B800U))->DOUT, (1u));
}
...
extern void LED_Trigger(void) {
    ...
    OS_ExitTaskCritical();
    do { if (!(led_tmpOnOffTime_ms != 0u)) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 95); } while (0); FAS_InfiniteLoop(); } } while (0);
    ...
    if (0u == (((uint64_t)counter * ((100u))) % led_tmpOnOffTime_ms)) {
        if (STD_PIN_HIGH == IO_PinGet(&(((hetBASE_t *)0xFFF7B800U))->DIN, (1u))) {
            IO_PinReset(&(((hetBASE_t *)0xFFF7B800U))->DOUT, (1u));
        } else {
            IO_PinSet(&(((hetBASE_t *)0xFFF7B800U))->DOUT, (1u));
        }
        counter = 0u;
...
extern void LED_SetToggleTime(uint32_t onOffTime_ms) {
    do { if (!(0u == (onOffTime_ms % ((100u))))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 115); } while (0); FAS_InfiniteLoop(); } } while (0);
    led_onOffTime_ms = onOffTime_ms;
    do { if (!(led_onOffTime_ms != 0u)) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 117); } while (0); FAS_InfiniteLoop(); } } while (0);
}
