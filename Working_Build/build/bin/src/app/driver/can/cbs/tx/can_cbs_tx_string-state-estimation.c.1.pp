...
extern uint32_t CANTX_StringStateEstimation(
    ...
    uint8_t *pMuxId,
    const CAN_SHIM_s *const kpkCanShim) {
    do { if (!(message . id == (0x71Au))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 82); } while (0); FAS_InfiniteLoop(); } } while (0);
    ...
    do { if (!(pCanData != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 85); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pMuxId != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 86); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(*pMuxId < (1u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 87); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(kpkCanShim != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 88); } while (0); FAS_InfiniteLoop(); } } while (0);
    ...
    CAN_TxSetMessageDataWithSignalData(&messageData, 60u, 4u, data, message.endianness);
    ...
    CAN_TxSetMessageDataWithSignalData(&messageData, 16u, 8u, data, message.endianness);
    ...
    CAN_TxSetMessageDataWithSignalData(&messageData, 24u, 8u, data, message.endianness);
    ...
    CAN_TxSetMessageDataWithSignalData(&messageData, 40u, 8u, data, message.endianness);
    ...
    CAN_TxSetMessageDataWithSignalData(&messageData, 32u, 8u, data, message.endianness);
    ...
    CAN_TxSetMessageDataWithSignalData(&messageData, 48u, 12u, data, message.endianness);
