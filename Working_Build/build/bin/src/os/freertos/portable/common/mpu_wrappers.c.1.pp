...
typedef TickType_t               EventBits_t;
    ...
    EventGroupHandle_t xEventGroupCreateStatic( StaticEventGroup_t * pxEventGroupBuffer ) __attribute__( ( section( ".kernelTEXT" ) ) );
...
EventBits_t xEventGroupClearBits( EventGroupHandle_t xEventGroup,
                                  const EventBits_t uxBitsToClear ) __attribute__( ( section( ".kernelTEXT" ) ) );
...
EventBits_t xEventGroupSetBits( EventGroupHandle_t xEventGroup,
                                const EventBits_t uxBitsToSet ) __attribute__( ( section( ".kernelTEXT" ) ) );
...
EventBits_t xEventGroupGetBitsFromISR( EventGroupHandle_t xEventGroup ) __attribute__( ( section( ".kernelTEXT" ) ) );
...
void vEventGroupDelete( EventGroupHandle_t xEventGroup ) __attribute__( ( section( ".kernelTEXT" ) ) );

 
void vEventGroupSetBitsCallback( void * pvEventGroup,
                                 const uint32_t ulBitsToSet ) __attribute__( ( section( ".kernelTEXT" ) ) );
void vEventGroupClearBitsCallback( void * pvEventGroup,
                                   const uint32_t ulBitsToClear ) __attribute__( ( section( ".kernelTEXT" ) ) );
...
BaseType_t MPU_xTaskCreate( TaskFunction_t pxTaskCode,
                            ...
                            void * const pvParameters,
                            UBaseType_t uxPriority,
                            TaskHandle_t * const pxCreatedTask ) __attribute__( ( section( ".syscallTEXT" ) ) );
TaskHandle_t MPU_xTaskCreateStatic( TaskFunction_t pxTaskCode,
                                    ...
                                    UBaseType_t uxPriority,
                                    StackType_t * const puxStackBuffer,
                                    StaticTask_t * const pxTaskBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
 
BaseType_t MPU_xTaskCreateRestricted( const TaskParameters_t * const pxTaskDefinition,
                                      TaskHandle_t * pxCreatedTask ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTaskCreateRestrictedStatic( const TaskParameters_t * const pxTaskDefinition,
                                            TaskHandle_t * pxCreatedTask ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskAllocateMPURegions( TaskHandle_t xTask,
                                  const MemoryRegion_t * const pxRegions ) __attribute__( ( section( ".syscallTEXT" ) ) );
 
void MPU_vTaskDelete( TaskHandle_t xTaskToDelete ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskDelay( const TickType_t xTicksToDelay ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTaskDelayUntil( TickType_t * const pxPreviousWakeTime,
                                const TickType_t xTimeIncrement ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTaskAbortDelay( TaskHandle_t xTask ) __attribute__( ( section( ".syscallTEXT" ) ) );
UBaseType_t MPU_uxTaskPriorityGet( const TaskHandle_t xTask ) __attribute__( ( section( ".syscallTEXT" ) ) );
eTaskState MPU_eTaskGetState( TaskHandle_t xTask ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskGetInfo( TaskHandle_t xTask,
                       TaskStatus_t * pxTaskStatus,
                       BaseType_t xGetFreeStackSpace,
                       eTaskState eState ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskPrioritySet( TaskHandle_t xTask,
                           UBaseType_t uxNewPriority ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskSuspend( TaskHandle_t xTaskToSuspend ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskResume( TaskHandle_t xTaskToResume ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskStartScheduler( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskSuspendAll( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTaskResumeAll( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
TickType_t MPU_xTaskGetTickCount( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
UBaseType_t MPU_uxTaskGetNumberOfTasks( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
char * MPU_pcTaskGetName( TaskHandle_t xTaskToQuery ) __attribute__( ( section( ".syscallTEXT" ) ) );
TaskHandle_t MPU_xTaskGetHandle( const char * pcNameToQuery ) __attribute__( ( section( ".syscallTEXT" ) ) );
UBaseType_t MPU_uxTaskGetStackHighWaterMark( TaskHandle_t xTask ) __attribute__( ( section( ".syscallTEXT" ) ) );
uint16_t MPU_uxTaskGetStackHighWaterMark2( TaskHandle_t xTask ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskSetApplicationTaskTag( TaskHandle_t xTask,
                                     TaskHookFunction_t pxHookFunction ) __attribute__( ( section( ".syscallTEXT" ) ) );
TaskHookFunction_t MPU_xTaskGetApplicationTaskTag( TaskHandle_t xTask ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskSetThreadLocalStoragePointer( TaskHandle_t xTaskToSet,
                                            BaseType_t xIndex,
                                            void * pvValue ) __attribute__( ( section( ".syscallTEXT" ) ) );
void * MPU_pvTaskGetThreadLocalStoragePointer( TaskHandle_t xTaskToQuery,
                                               BaseType_t xIndex ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTaskCallApplicationTaskHook( TaskHandle_t xTask,
                                             void * pvParameter ) __attribute__( ( section( ".syscallTEXT" ) ) );
TaskHandle_t MPU_xTaskGetIdleTaskHandle( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
UBaseType_t MPU_uxTaskGetSystemState( TaskStatus_t * const pxTaskStatusArray,
                                      const UBaseType_t uxArraySize,
                                      uint32_t * const pulTotalRunTime ) __attribute__( ( section( ".syscallTEXT" ) ) );
uint32_t MPU_ulTaskGetIdleRunTimeCounter( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
uint32_t MPU_ulTaskGetIdleRunTimePercent( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskList( char * pcWriteBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskGetRunTimeStats( char * pcWriteBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTaskGenericNotify( TaskHandle_t xTaskToNotify,
                                   UBaseType_t uxIndexToNotify,
                                   uint32_t ulValue,
                                   eNotifyAction eAction,
                                   uint32_t * pulPreviousNotificationValue ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTaskGenericNotifyWait( UBaseType_t uxIndexToWaitOn,
                                       uint32_t ulBitsToClearOnEntry,
                                       uint32_t ulBitsToClearOnExit,
                                       uint32_t * pulNotificationValue,
                                       TickType_t xTicksToWait ) __attribute__( ( section( ".syscallTEXT" ) ) );
uint32_t MPU_ulTaskGenericNotifyTake( UBaseType_t uxIndexToWaitOn,
                                      BaseType_t xClearCountOnExit,
                                      TickType_t xTicksToWait ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTaskGenericNotifyStateClear( TaskHandle_t xTask,
                                             UBaseType_t uxIndexToClear ) __attribute__( ( section( ".syscallTEXT" ) ) );
uint32_t MPU_ulTaskGenericNotifyValueClear( TaskHandle_t xTask,
                                            UBaseType_t uxIndexToClear,
                                            uint32_t ulBitsToClear ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTaskIncrementTick( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
TaskHandle_t MPU_xTaskGetCurrentTaskHandle( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskSetTimeOutState( TimeOut_t * const pxTimeOut ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTaskCheckForTimeOut( TimeOut_t * const pxTimeOut,
                                     TickType_t * const pxTicksToWait ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTaskMissedYield( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTaskGetSchedulerState( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTaskCatchUpTicks( TickType_t xTicksToCatchUp ) __attribute__( ( section( ".syscallTEXT" ) ) );

 
BaseType_t MPU_xQueueGenericSend( QueueHandle_t xQueue,
                                  const void * const pvItemToQueue,
                                  TickType_t xTicksToWait,
                                  const BaseType_t xCopyPosition ) __attribute__( ( section( ".syscallTEXT" ) ) );
...
BaseType_t MPU_xQueueSemaphoreTake( QueueHandle_t xQueue,
                                    TickType_t xTicksToWait ) __attribute__( ( section( ".syscallTEXT" ) ) );
UBaseType_t MPU_uxQueueMessagesWaiting( const QueueHandle_t xQueue ) __attribute__( ( section( ".syscallTEXT" ) ) );
UBaseType_t MPU_uxQueueSpacesAvailable( const QueueHandle_t xQueue ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vQueueDelete( QueueHandle_t xQueue ) __attribute__( ( section( ".syscallTEXT" ) ) );
QueueHandle_t MPU_xQueueCreateMutex( const uint8_t ucQueueType ) __attribute__( ( section( ".syscallTEXT" ) ) );
QueueHandle_t MPU_xQueueCreateMutexStatic( const uint8_t ucQueueType,
                                           StaticQueue_t * pxStaticQueue ) __attribute__( ( section( ".syscallTEXT" ) ) );
QueueHandle_t MPU_xQueueCreateCountingSemaphore( const UBaseType_t uxMaxCount,
                                                 const UBaseType_t uxInitialCount ) __attribute__( ( section( ".syscallTEXT" ) ) );
QueueHandle_t MPU_xQueueCreateCountingSemaphoreStatic( const UBaseType_t uxMaxCount,
                                                       const UBaseType_t uxInitialCount,
                                                       StaticQueue_t * pxStaticQueue ) __attribute__( ( section( ".syscallTEXT" ) ) );
TaskHandle_t MPU_xQueueGetMutexHolder( QueueHandle_t xSemaphore ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xQueueTakeMutexRecursive( QueueHandle_t xMutex,
                                         TickType_t xTicksToWait ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xQueueGiveMutexRecursive( QueueHandle_t pxMutex ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vQueueAddToRegistry( QueueHandle_t xQueue,
                              const char * pcName ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vQueueUnregisterQueue( QueueHandle_t xQueue ) __attribute__( ( section( ".syscallTEXT" ) ) );
const char * MPU_pcQueueGetName( QueueHandle_t xQueue ) __attribute__( ( section( ".syscallTEXT" ) ) );
QueueHandle_t MPU_xQueueGenericCreate( const UBaseType_t uxQueueLength,
                                       const UBaseType_t uxItemSize,
                                       const uint8_t ucQueueType ) __attribute__( ( section( ".syscallTEXT" ) ) );
QueueHandle_t MPU_xQueueGenericCreateStatic( const UBaseType_t uxQueueLength,
                                             const UBaseType_t uxItemSize,
                                             uint8_t * pucQueueStorage,
                                             StaticQueue_t * pxStaticQueue,
                                             const uint8_t ucQueueType ) __attribute__( ( section( ".syscallTEXT" ) ) );
QueueSetHandle_t MPU_xQueueCreateSet( const UBaseType_t uxEventQueueLength ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xQueueAddToSet( QueueSetMemberHandle_t xQueueOrSemaphore,
                               QueueSetHandle_t xQueueSet ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xQueueRemoveFromSet( QueueSetMemberHandle_t xQueueOrSemaphore,
                                    QueueSetHandle_t xQueueSet ) __attribute__( ( section( ".syscallTEXT" ) ) );
QueueSetMemberHandle_t MPU_xQueueSelectFromSet( QueueSetHandle_t xQueueSet,
                                                const TickType_t xTicksToWait ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xQueueGenericReset( QueueHandle_t xQueue,
                                   BaseType_t xNewQueue ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vQueueSetQueueNumber( QueueHandle_t xQueue,
                               UBaseType_t uxQueueNumber ) __attribute__( ( section( ".syscallTEXT" ) ) );
UBaseType_t MPU_uxQueueGetQueueNumber( QueueHandle_t xQueue ) __attribute__( ( section( ".syscallTEXT" ) ) );
uint8_t MPU_ucQueueGetQueueType( QueueHandle_t xQueue ) __attribute__( ( section( ".syscallTEXT" ) ) );
...
TimerHandle_t MPU_xTimerCreate( const char * const pcTimerName,
                                ...
                                const UBaseType_t uxAutoReload,
                                void * const pvTimerID,
                                TimerCallbackFunction_t pxCallbackFunction ) __attribute__( ( section( ".syscallTEXT" ) ) );
TimerHandle_t MPU_xTimerCreateStatic( const char * const pcTimerName,
                                      const TickType_t xTimerPeriodInTicks,
                                      const UBaseType_t uxAutoReload,
                                      void * const pvTimerID,
                                      TimerCallbackFunction_t pxCallbackFunction,
                                      StaticTimer_t * pxTimerBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
void * MPU_pvTimerGetTimerID( const TimerHandle_t xTimer ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTimerSetTimerID( TimerHandle_t xTimer,
                           void * pvNewID ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTimerIsTimerActive( TimerHandle_t xTimer ) __attribute__( ( section( ".syscallTEXT" ) ) );
TaskHandle_t MPU_xTimerGetTimerDaemonTaskHandle( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTimerPendFunctionCall( PendedFunction_t xFunctionToPend,
                                       void * pvParameter1,
                                       uint32_t ulParameter2,
                                       TickType_t xTicksToWait ) __attribute__( ( section( ".syscallTEXT" ) ) );
const char * MPU_pcTimerGetName( TimerHandle_t xTimer ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vTimerSetReloadMode( TimerHandle_t xTimer,
                              const UBaseType_t uxAutoReload ) __attribute__( ( section( ".syscallTEXT" ) ) );
UBaseType_t MPU_uxTimerGetReloadMode( TimerHandle_t xTimer ) __attribute__( ( section( ".syscallTEXT" ) ) );
TickType_t MPU_xTimerGetPeriod( TimerHandle_t xTimer ) __attribute__( ( section( ".syscallTEXT" ) ) );
TickType_t MPU_xTimerGetExpiryTime( TimerHandle_t xTimer ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xTimerCreateTimerTask( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
...
EventGroupHandle_t MPU_xEventGroupCreate( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
EventGroupHandle_t MPU_xEventGroupCreateStatic( StaticEventGroup_t * pxEventGroupBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
...
EventBits_t MPU_xEventGroupClearBits( EventGroupHandle_t xEventGroup,
                                      const EventBits_t uxBitsToClear ) __attribute__( ( section( ".syscallTEXT" ) ) );
EventBits_t MPU_xEventGroupSetBits( EventGroupHandle_t xEventGroup,
                                    const EventBits_t uxBitsToSet ) __attribute__( ( section( ".syscallTEXT" ) ) );
EventBits_t MPU_xEventGroupSync( EventGroupHandle_t xEventGroup,
                                 const EventBits_t uxBitsToSet,
                                 const EventBits_t uxBitsToWaitFor,
                                 TickType_t xTicksToWait ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vEventGroupDelete( EventGroupHandle_t xEventGroup ) __attribute__( ( section( ".syscallTEXT" ) ) );
UBaseType_t MPU_uxEventGroupGetNumber( void * xEventGroup ) __attribute__( ( section( ".syscallTEXT" ) ) );
...
size_t MPU_xStreamBufferReceive( StreamBufferHandle_t xStreamBuffer,
                                 ...
                                 size_t xBufferLengthBytes,
                                 TickType_t xTicksToWait ) __attribute__( ( section( ".syscallTEXT" ) ) );
size_t MPU_xStreamBufferNextMessageLengthBytes( StreamBufferHandle_t xStreamBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
void MPU_vStreamBufferDelete( StreamBufferHandle_t xStreamBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xStreamBufferIsFull( StreamBufferHandle_t xStreamBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xStreamBufferIsEmpty( StreamBufferHandle_t xStreamBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xStreamBufferReset( StreamBufferHandle_t xStreamBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
size_t MPU_xStreamBufferSpacesAvailable( StreamBufferHandle_t xStreamBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
size_t MPU_xStreamBufferBytesAvailable( StreamBufferHandle_t xStreamBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
BaseType_t MPU_xStreamBufferSetTriggerLevel( StreamBufferHandle_t xStreamBuffer,
                                             size_t xTriggerLevel ) __attribute__( ( section( ".syscallTEXT" ) ) );
StreamBufferHandle_t MPU_xStreamBufferGenericCreate( size_t xBufferSizeBytes,
                                                     size_t xTriggerLevelBytes,
                                                     BaseType_t xIsMessageBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
StreamBufferHandle_t MPU_xStreamBufferGenericCreateStatic( size_t xBufferSizeBytes,
                                                           size_t xTriggerLevelBytes,
                                                           BaseType_t xIsMessageBuffer,
                                                           uint8_t * const pucStreamBufferStorageArea,
                                                           StaticStreamBuffer_t * const pxStaticStreamBuffer ) __attribute__( ( section( ".syscallTEXT" ) ) );
...
extern BaseType_t xPortRaisePrivilege( void ) __attribute__( ( section( ".syscallTEXT" ) ) );
