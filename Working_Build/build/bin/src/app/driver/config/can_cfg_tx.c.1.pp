...
const CAN_TX_MESSAGE_TYPE_s can_txMessages[] = {
    ...
    {((CAN_NODE_s *)&can_node1), { . id = (0x351u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (100u), . phase = (30u) }, &CANTX_LimitValues, ((void *)0x0U)},
    {((CAN_NODE_s *)&can_node1), { . id = (0x223u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (100u), . phase = (40u) }, &CANTX_MinimumMaximumValues, ((void *)0x0U)},
    {((CAN_NODE_s *)&can_node1), { . id = (0x225u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (1000u), . phase = (50u) }, &CANTX_PackStateEstimation, ((void *)0x0U)},
    {((CAN_NODE_s *)&can_node1), { . id = (0x356u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (100u), . phase = (60u) }, &CANTX_PackValues, ((void *)0x0U)},
