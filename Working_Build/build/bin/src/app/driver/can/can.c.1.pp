...
_Static_assert(((61u) <= (64u)), "Lower mailbox number must not be greater than higher mailbox number");
_Static_assert(((64u) <= (64u)), "Highest mailbox number must not be larger than total number of mailboxes");
...
static CAN_STATE_s can_state = {
    .periodicEnable         = 0,
    .currentSensorPresent   = {(0)},
    .currentSensorCCPresent = {(0)},
    .currentSensorECPresent = {(0)},
};
...
static void CAN_SetCurrentSensorPresent(_Bool command, uint8_t stringNumber);
...
static void CAN_SetCurrentSensorCcPresent(_Bool command, uint8_t stringNumber);
...
static void CAN_SetCurrentSensorEcPresent(_Bool command, uint8_t stringNumber);
...
static void CAN_ConfigureRxMailboxesForExtendedIdentifiers(void) {
    ...
    ((canBASE_t *)0xFFF7DC00U)->CTL = (uint32)0x00000000U | (uint32)0x00000000U | (uint32)((uint32)0x0000000AU << 10U) |
                   (uint32)0x00020043U;
    ...
    ((canBASE_t *)0xFFF7DC00U)->IF1ARB = (uint32)0x80000000U | (uint32)0x00000000U | (uint32)0x00000000U |
    ...
    ((canBASE_t *)0xFFF7DC00U)->IF1NO   = 42U;
    ...
    ((canBASE_t *)0xFFF7DC00U)->IF1MSK = 0xC0000000U | (uint32)((uint32)((uint32)0x00000000U & (uint32)0x1FFFFFFFU) << (uint32)0U);
    ((canBASE_t *)0xFFF7DC00U)->IF1ARB = (uint32)0x80000000U | (uint32)0x40000000U | (uint32)0x00000000U |
    ...
    ((canBASE_t *)0xFFF7DC00U)->IF2MSK = 0xC0000000U | (uint32)((uint32)((uint32)0x00000000U & (uint32)0x1FFFFFFFU) << (uint32)0U);
    ((canBASE_t *)0xFFF7DC00U)->IF2ARB = (uint32)0x80000000U | (uint32)0x40000000U | (uint32)0x00000000U |
                      (uint32)((uint32)((uint32)0U & (uint32)0x1FFFFFFFU) << (uint32)0U);
    ...
    ((canBASE_t *)0xFFF7DE00U)->CTL = (uint32)0x00000000U | (uint32)0x00000000U | (uint32)((uint32)0x0000000AU << 10U) | 0x00020043U;
    ...
    ((canBASE_t *)0xFFF7DE00U)->IF1MSK = 0xC0000000U | (uint32)((uint32)((uint32)0x00000000U & (uint32)0x1FFFFFFFU) << (uint32)0U);
    ((canBASE_t *)0xFFF7DE00U)->IF1ARB = (uint32)0x80000000U | (uint32)0x40000000U | (uint32)0x00000000U |
                      (uint32)((uint32)((uint32)0U & (uint32)0x1FFFFFFFU) << (uint32)0U);
    ...
    ((canBASE_t *)0xFFF7DE00U)->IF2MSK = 0xC0000000U | (uint32)((uint32)((uint32)0x00000000U & (uint32)0x1FFFFFFFU) << (uint32)0U);
    ((canBASE_t *)0xFFF7DE00U)->IF2ARB = (uint32)0x80000000U | (uint32)0x40000000U | (uint32)0x00000000U |
                      (uint32)((uint32)((uint32)0U & (uint32)0x1FFFFFFFU) << (uint32)0U);
...
static void CAN_InitializeTransceiver(void) {
    ...
    PEX_SetPinDirectionOutput((1u), ((0u)));
    PEX_SetPinDirectionOutput((1u), ((1u)));
    PEX_SetPin((1u), ((0u)));
    PEX_SetPin((1u), ((1u)));

     
    PEX_SetPinDirectionOutput((1u), ((2u)));
    PEX_SetPinDirectionOutput((1u), ((3u)));
    PEX_SetPin((1u), ((2u)));
    PEX_SetPin((1u), ((3u)));
}
...
static void CAN_ValidateConfiguredTxMessagePeriod(void) {
    for (uint16_t i = 0u; i < can_txLength; i++) {
        if (can_txMessages[i].timing.period == 0u) {
            do { if (!((0u == 1u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 552); } while (0); FAS_InfiniteLoop(); } } while (0);
        }
    }
}

static CAN_NODE_s *CAN_GetNodeConfigurationStructFromRegisterAddress(canBASE_t *pNodeRegister) {
    do { if (!(pNodeRegister != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 558); } while (0); FAS_InfiniteLoop(); } } while (0);
    CAN_NODE_s *node = ((void *)(0u));
    ...
    if (pNodeRegister == can_node1.canNodeRegister) {
        ...
        do { if (!((0u == 1u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 567); } while (0); FAS_InfiniteLoop(); } } while (0);
    }
    return node;
}

static void CAN_RxInterrupt(canBASE_t *pNode, uint32 messageBox) {
    do { if (!(pNode != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 573); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(messageBox <= (64u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 574); } while (0); FAS_InfiniteLoop(); } } while (0);  

    uint8_t messageData[(8u)] = {0u};
    ...
    uint32_t retval = canGetData(pNode, messageBox, (uint8 *)&messageData[0]);  

     
    if ((ftsk_allQueuesCreated == 1) && (retval == (1u))) {
        CAN_BUFFER_ELEMENT_s can_rxBuffer = {((void *)(0u)), 0u, CAN_INVALID_TYPE, {0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u}};
        ...
        if (!((messageBox >= (61u)) &&
            ...
            can_rxBuffer.id     = canGetID(pNode, messageBox) >> (18u);
            can_rxBuffer.idType = CAN_STANDARD_IDENTIFIER_11_BIT;
        } else {
             
            can_rxBuffer.id     = canGetID(pNode, messageBox) >> (0u);
            can_rxBuffer.idType = CAN_EXTENDED_IDENTIFIER_29_BIT;
        }

         
        can_rxBuffer.data[(0u)] = messageData[(0u)];
        can_rxBuffer.data[(1u)] = messageData[(1u)];
        can_rxBuffer.data[(2u)] = messageData[(2u)];
        can_rxBuffer.data[(3u)] = messageData[(3u)];
        can_rxBuffer.data[(4u)] = messageData[(4u)];
        can_rxBuffer.data[(5u)] = messageData[(5u)];
        can_rxBuffer.data[(6u)] = messageData[(6u)];
        can_rxBuffer.data[(7u)] = messageData[(7u)];

        if (OS_SendToBackOfQueueFromIsr(ftsk_canRxQueue, (void *)&can_rxBuffer, ((void *)(0u))) == OS_SUCCESS) {
...
static STD_RETURN_TYPE_e CAN_PeriodicTransmit(void) {
    ...
    for (uint16_t i = 0u; i < can_txLength; i++) {
        if (((counterTicks * (10u)) % (can_txMessages[i].timing.period)) == can_txMessages[i].timing.phase) {
            if (can_txMessages[i].callbackFunction != ((void *)(0u))) {
...
static void CAN_CheckCanTiming(void) {
    ...
    (DATA_Read2DataBlocks) (&stateRequestTab, &errorFlagsTab);

     
    if ((currentTime - stateRequestTab.header.timestamp) <= (105u)) {
...
static void CAN_CheckCanTimingOfCurrentSensor(void) {
    ...
    (DATA_Read1DataBlock) (&currentTab);

    for (uint8_t s = 0u; s < (1u); s++) {
         
        if (currentTab.timestampCurrent[s] != 0u) {
             
            if ((currentTime - currentTab.timestampCurrent[s]) > (200u)) {
                ...
                if (can_state.currentSensorPresent[s] == 0) {
                    CAN_SetCurrentSensorPresent(1, s);
                }
            }
        }
        ...
        if (currentTab.timestampCurrentCounting[s] != 0) {
            if ((currentTime - currentTab.timestampCurrentCounting[s]) >
                ...
                if (can_state.currentSensorCCPresent[s] == 0) {
                    CAN_SetCurrentSensorCcPresent(1, s);
                }
            }
        }
        ...
        if (currentTab.timestampEnergyCounting[s] != 0) {
            if ((currentTime - currentTab.timestampEnergyCounting[s]) >
                ...
                if (can_state.currentSensorECPresent[s] == 0) {
                    CAN_SetCurrentSensorEcPresent(1, s);
                }
            }
        }
    }
...
static void CAN_SetCurrentSensorPresent(_Bool command, uint8_t stringNumber) {
    if (command == 1) {
        ...
        can_state.currentSensorPresent[stringNumber] = 1;
        OS_ExitTaskCritical();
    } else {
        OS_EnterTaskCritical();
        can_state.currentSensorPresent[stringNumber] = 0;
        OS_ExitTaskCritical();
    }
}
...
static void CAN_SetCurrentSensorCcPresent(_Bool command, uint8_t stringNumber) {
    if (command == 1) {
        OS_EnterTaskCritical();
        can_state.currentSensorCCPresent[stringNumber] = 1;
        OS_ExitTaskCritical();
    } else {
        OS_EnterTaskCritical();
        can_state.currentSensorCCPresent[stringNumber] = 0;
        OS_ExitTaskCritical();
    }
}
...
static void CAN_SetCurrentSensorEcPresent(_Bool command, uint8_t stringNumber) {
    if (command == 1) {
        OS_EnterTaskCritical();
        can_state.currentSensorECPresent[stringNumber] = 1;
        OS_ExitTaskCritical();
    } else {
        OS_EnterTaskCritical();
        can_state.currentSensorECPresent[stringNumber] = 0;
        OS_ExitTaskCritical();
    }
}
...
extern STD_RETURN_TYPE_e CAN_DataSend(CAN_NODE_s *pNode, uint32_t id, CAN_IDENTIFIER_TYPE_e idType, uint8 *pData) {
    do { if (!(pNode != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 782); } while (0); FAS_InfiniteLoop(); } } while (0);
     
    do { if (!((idType == CAN_STANDARD_IDENTIFIER_11_BIT) || (idType == CAN_EXTENDED_IDENTIFIER_29_BIT))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 784); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pData != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 785); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!((pNode == ((CAN_NODE_s *)&can_node1)) || (pNode == ((CAN_NODE_s *)&can_node2Isolated)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 786); } while (0); FAS_InfiniteLoop(); } } while (0);
    ...
    for (uint8_t messageBox = 1u; messageBox <= (32u); messageBox++) {
...
extern void CAN_MainFunction(void) {
    CAN_CheckCanTiming();
    if (can_state.periodicEnable == 1) {
        CAN_PeriodicTransmit();
    }
}

extern void CAN_ReadRxBuffer(void) {
    if (ftsk_allQueuesCreated == 1) {
        CAN_BUFFER_ELEMENT_s can_rxBuffer = {((void *)(0u)), 0u, CAN_INVALID_TYPE, {0u, 0u, 0u, 0u, 0u, 0u, 0u, 0u}};
        while (OS_ReceiveFromQueue(ftsk_canRxQueue, (void *)&can_rxBuffer, 0u) == OS_SUCCESS) {
            ...
            for (uint16_t i = 0u; i < can_rxLength; i++) {
                if ((can_rxBuffer.canNode == can_rxMessages[i].canNode) &&
                    ...
                    if (can_rxMessages[i].callbackFunction != ((void *)(0u))) {
...
extern void CAN_EnablePeriodic(_Bool command) {
    if (command == 1) {
        can_state.periodicEnable = 1;
    } else {
        can_state.periodicEnable = 0;
    }
}

extern _Bool CAN_IsCurrentSensorPresent(uint8_t stringNumber) {
    do { if (!(stringNumber < (1u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 858); } while (0); FAS_InfiniteLoop(); } } while (0);
    return can_state.currentSensorPresent[stringNumber];
}

extern _Bool CAN_IsCurrentSensorCcPresent(uint8_t stringNumber) {
    do { if (!(stringNumber < (1u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 863); } while (0); FAS_InfiniteLoop(); } } while (0);
    return can_state.currentSensorCCPresent[stringNumber];
}

extern _Bool CAN_IsCurrentSensorEcPresent(uint8_t stringNumber) {
    do { if (!(stringNumber < (1u))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 868); } while (0); FAS_InfiniteLoop(); } } while (0);
