...
const CAN_TX_MESSAGE_TYPE_s can_txMessages[] = {
    {((CAN_NODE_s *)&can_node1), { . id = (0x359u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (100u), . phase = (0u) }, &CANTX_BmsState, ((void *)0x0U)},
    {((CAN_NODE_s *)&can_node1), { . id = (0x226u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (1000u), . phase = (100u) }, &CANTX_BmsStateDetails, ((void *)0x0U)},
    {((CAN_NODE_s *)&can_node1), { . id = (0x240u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (100u), . phase = (10u) }, &CANTX_CellVoltages, &cantx_voltagesMux},
    {((CAN_NODE_s *)&can_node1), { . id = (0x250u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (200u), . phase = (20u) }, &CANTX_CellTemperatures, &cantx_temperaturesMux},
    
    {((CAN_NODE_s *)&can_node1), { . id = (0x351u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (100u), . phase = (30u) }, &BatteryLimits, ((void *)0x0U)},
    {((CAN_NODE_s *)&can_node1), { . id = (0x71Du), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_BIG_ENDIAN), }, { . period = (100u), . phase = (30u) }, &ModuleLimits, ((void *)0x0U)},
    
    {((CAN_NODE_s *)&can_node1), { . id = (0x71Cu), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_BIG_ENDIAN), }, { . period = (100u), . phase = (40u) }, &CellMeasurements, ((void *)0x0U)},
    
    {((CAN_NODE_s *)&can_node1), { . id = (0x71Bu), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_BIG_ENDIAN), }, { . period = (1000u), . phase = (50u) }, &ModuleStateEstimation, ((void *)0x0U)},
    
    {((CAN_NODE_s *)&can_node1), { . id = (0x356u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (100u), . phase = (60u) }, &BatteryMeasurements, ((void *)0x0U)},
    {((CAN_NODE_s *)&can_node1), { . id = (0x71Eu), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (100u), . phase = (70u) }, &CANTX_StringState, &cantx_stringStateMux},
    {((CAN_NODE_s *)&can_node1), { . id = (0x281u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (100u), . phase = (90u) }, &CANTX_StringMinimumMaximumValues, &cantx_stringMinMaxMux},
    {((CAN_NODE_s *)&can_node1), { . id = (0x71Au), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (1000u), . phase = (0u) }, &CANTX_StringStateEstimation, &cantx_stringStateEstimationMux},
    {((CAN_NODE_s *)&can_node1), { . id = (0x71Bu), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (100u), . phase = (80u) }, &CANTX_StringValuesP0, &cantx_stringValuesP0Mux},
    {((CAN_NODE_s *)&can_node1), { . id = (0x283u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = (100u), . phase = (10u) }, &CANTX_StringValuesP1, &cantx_stringValuesP1Mux},
};
