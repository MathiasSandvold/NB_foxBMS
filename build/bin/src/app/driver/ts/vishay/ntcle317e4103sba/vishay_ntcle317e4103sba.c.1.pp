...
extern int16_t TS_Vis01GetTemperatureFromLut(uint16_t adcVoltage_mV) {
    ...
    if (adcVoltage_V > ((float_t)(((3.0f) * ts_ntcle317e4103sbaLut[0u]. resistance_Ohm) / (ts_ntcle317e4103sbaLut[0u]. resistance_Ohm+(10000.0f))))) {
         
        temperature_ddegC = (-0x7fff-1);
    } else if (adcVoltage_V < ((float_t)(((3.0f) * ts_ntcle317e4103sbaLut[ts_ntcle317e4103sbaLutSize - 1u]. resistance_Ohm) / (ts_ntcle317e4103sbaLut[ts_ntcle317e4103sbaLutSize - 1u]. resistance_Ohm+(10000.0f))))) {
        ...
        if (!(((between_high == 0u) && (between_low == 0u)) ||  
              (between_low >= ts_ntcle317e4103sbaLutSize))) {   
