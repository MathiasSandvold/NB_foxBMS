                            ...
                            uint32 regNum, volatile uint16 * dataPtr)
{
    ...
    while(((*((volatile uint32 *)(baseAddr + (0x80U)))) & (0x80000000U)) == (0x80000000U))
    { 
	}  

    (*((volatile uint32 *)(baseAddr + (0x80U))))
                           = (((uint32)(0x00000000U)) | (0x80000000U)
                              |((regNum & (0x1FU)) << (21U))
                              |((phyAddr & (0x1FU)) << (16U)));
    ...
    if((((*((volatile uint32 *)(baseAddr + (0x80U))))) & (0x20000000U)) == (0x20000000U))
    {
	 
        *dataPtr = (uint16)(((*((volatile uint32 *)(baseAddr + (0x80U)))))
                                    & (0xFFFFU));
        retVal = 1;
    }
...
{
    return ((*((volatile uint32 *)(baseAddr + (0x8U)))));
}
...
{
    return ((*((volatile uint32 *)(baseAddr + (0xCU)))));
}
              ...
              uint32 mdioOutputFreq)
{
   ...
   (*((volatile uint32 *)(baseAddr + (0x4U)))) = ((clkDiv & (0x0000FFFFU))
                                     | (0x40000000U) 
                                     | (0x00100000U)
                                     | (0x00040000U));
}
...
void MDIOEnable(uint32 baseAddr) {
	(*((volatile uint32 *)(baseAddr + (0x4U)))) = (*((volatile uint32 *)(baseAddr + (0x4U))))
			| (0x40000000U);
}
