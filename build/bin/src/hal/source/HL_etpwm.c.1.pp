...
void etpwmInit(void)
{
    ...
    ((etpwmBASE_t *)0xFCF78C00U)->TBPRD = 4999U;

     
    ((etpwmBASE_t *)0xFCF78C00U)->CMPA = 2500U;

     
    ((etpwmBASE_t *)0xFCF78C00U)->CMPB = 2500U;
    ...
    ((etpwmBASE_t *)0xFCF78C00U)->DBRED = 0U;

     
    ((etpwmBASE_t *)0xFCF78C00U)->DBFED = 0U ;
...
void etpwmStartTBCLK(void)
{
	...
	((pinMuxBASE_t *) 0xFFFF1C00U)->PINMUX[166U] = (((pinMuxBASE_t *) 0xFFFF1C00U)->PINMUX[166U] & (~(uint32)((uint32)0xFFU << 0U))) | (((uint32)((uint32)0x2U << 0U)));
...
void etpwmStopTBCLK(void)
{
	...
	((pinMuxBASE_t *) 0xFFFF1C00U)->PINMUX[166U] = (((pinMuxBASE_t *) 0xFFFF1C00U)->PINMUX[166U] & (~(uint32)((uint32)0xFFU << 0U))) | (((uint32)((uint32)0x0U << 0U)));
...
void etpwm1GetConfigValue(etpwm_config_reg_t *config_reg, config_value_type_t type)
{
	if (type == InitialValue)
	{
		...
		config_reg->CONFIG_TBPRD        = 4999U;
		config_reg->CONFIG_CMPCTL       = 0x00000000U;
		config_reg->CONFIG_CMPA         = 2500U;
		config_reg->CONFIG_CMPB         = 2500U;
		...
		config_reg->CONFIG_DBRED        = 0U;
		config_reg->CONFIG_DBFED        = 0U;
		...
		config_reg->CONFIG_ETSEL        = ((((uint16)NO_EVENT == 0U)? 0x0000U : 0x0008U) | (uint16)NO_EVENT | (uint16)0x0000U | (uint16)0x0000U | (uint16)((uint16)DCAEVT1 << 8U) | (uint16)((uint16)DCBEVT1 << 12U));
		config_reg->CONFIG_ETPS         = (1U | (uint16)((uint16)1U << 8U) | (uint16)((uint16)1U << 12U));
		config_reg->CONFIG_PCCTL        = ((uint16)((uint16)0U << 0U) | (uint16)((uint16)0U << 1U) | (uint16)((uint16)3U << 8U) | (uint16)((uint16)0U << 5U));
...
void etpwm2GetConfigValue(etpwm_config_reg_t *config_reg, config_value_type_t type)
{
	...
	{
	    config_reg->CONFIG_TBCTL        = ((etpwmBASE_t *)0xFCF78D00U)->TBCTL;
...
void etpwm5GetConfigValue(etpwm_config_reg_t *config_reg, config_value_type_t type)
{
	...
	{
	    config_reg->CONFIG_TBCTL        = ((etpwmBASE_t *)0xFCF79000U)->TBCTL;
