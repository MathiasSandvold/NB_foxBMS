...
const CAN_RX_MESSAGE_TYPE_s can_rxMessages[] = {
    {(((CAN_NODE_s *)&can_node1)), { . id = (0x37u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = CAN_LITTLE_ENDIAN, }, { . period = (0u) }, &CANRX_ImdInfo},
    {(((CAN_NODE_s *)&can_node1)), { . id = (0x23u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = CAN_LITTLE_ENDIAN, }, { . period = (0u) }, &CANRX_ImdResponse},
    {((CAN_NODE_s *)&can_node1), { . id = (0x230u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = ((0u)) }, &CANRX_BmsStateRequest},
    {(((CAN_NODE_s *)&can_node2Isolated)), { . id = (0x521u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (6u), . endianness = (CAN_BIG_ENDIAN), }, { . period = ((0u)) }, &CANRX_CurrentSensor},
    {(((CAN_NODE_s *)&can_node2Isolated)), { . id = (0x522u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (6u), . endianness = (CAN_BIG_ENDIAN), }, { . period = ((0u)) }, &CANRX_CurrentSensor},
    {(((CAN_NODE_s *)&can_node2Isolated)), { . id = (0x523u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (6u), . endianness = (CAN_BIG_ENDIAN), }, { . period = ((0u)) }, &CANRX_CurrentSensor},
    {(((CAN_NODE_s *)&can_node2Isolated)), { . id = (0x524u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (6u), . endianness = (CAN_BIG_ENDIAN), }, { . period = ((0u)) }, &CANRX_CurrentSensor},
    {(((CAN_NODE_s *)&can_node2Isolated)), { . id = (0x525u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (6u), . endianness = (CAN_BIG_ENDIAN), }, { . period = ((0u)) }, &CANRX_CurrentSensor},
    {(((CAN_NODE_s *)&can_node2Isolated)), { . id = (0x526u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (6u), . endianness = (CAN_BIG_ENDIAN), }, { . period = ((0u)) }, &CANRX_CurrentSensor},
    {(((CAN_NODE_s *)&can_node2Isolated)), { . id = (0x527u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (6u), . endianness = (CAN_BIG_ENDIAN), }, { . period = ((0u)) }, &CANRX_CurrentSensor},
    {(((CAN_NODE_s *)&can_node2Isolated)), { . id = (0x528u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (6u), . endianness = (CAN_BIG_ENDIAN), }, { . period = ((0u)) }, &CANRX_CurrentSensor},
    {(((CAN_NODE_s *)&can_node1)), { . id = (0x200u), . idType = (CAN_STANDARD_IDENTIFIER_11_BIT), . dlc = (8u), . endianness = (CAN_LITTLE_ENDIAN), }, { . period = ((0u)) }, &CANRX_Debug},
};
