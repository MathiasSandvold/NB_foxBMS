...
extern void FTSK_CreateTaskEngine(void *const pvParameters) {
    do { if (!(pvParameters == ((void *)0x0U))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 77); } while (0); FAS_InfiniteLoop(); } } while (0);
...
extern void FTSK_CreateTaskCyclic1ms(void *const pvParameters) {
    do { if (!(pvParameters == ((void *)0x0U))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 99); } while (0); FAS_InfiniteLoop(); } } while (0);
    OS_MarkTaskAsRequiringFpuContext();
...
extern void FTSK_CreateTaskCyclic10ms(void *const pvParameters) {
    do { if (!(pvParameters == ((void *)0x0U))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 131); } while (0); FAS_InfiniteLoop(); } } while (0);
    OS_MarkTaskAsRequiringFpuContext();
...
extern void FTSK_CreateTaskCyclic100ms(void *const pvParameters) {
    do { if (!(pvParameters == ((void *)0x0U))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 160); } while (0); FAS_InfiniteLoop(); } } while (0);
    OS_MarkTaskAsRequiringFpuContext();
...
extern void FTSK_CreateTaskCyclicAlgorithm100ms(void *const pvParameters) {
    do { if (!(pvParameters == ((void *)0x0U))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 189); } while (0); FAS_InfiniteLoop(); } } while (0);
    OS_MarkTaskAsRequiringFpuContext();
...
extern void FTSK_CreateTaskI2c(void *const pvParameters) {
    do { if (!(pvParameters == ((void *)0x0U))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 220); } while (0); FAS_InfiniteLoop(); } } while (0);
    OS_MarkTaskAsRequiringFpuContext();
...
extern void FTSK_CreateTaskAfe(void *const pvParameters) {
    do { if (!(pvParameters == ((void *)0x0U))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 240); } while (0); FAS_InfiniteLoop(); } } while (0);
    OS_MarkTaskAsRequiringFpuContext();
