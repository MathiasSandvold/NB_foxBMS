...
static void SOF_CalculateCurves(const SOF_CONFIG_s *pConfigurationValues, SOF_CURVE_s *pCalculatedSofCurveValues) {
    do { if (!(pConfigurationValues != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 144); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pCalculatedSofCurveValues != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 145); } while (0); FAS_InfiniteLoop(); } } while (0);
...
static void SOF_CalculateVoltageBasedCurrentLimit(
    ...
    const SOF_CONFIG_s *pConfigLimitValues,
    SOF_CURVE_s *pCalculatedSofCurves) {
    do { if (!(pAllowedVoltageBasedCurrent != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 197); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pConfigLimitValues != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 198); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pCalculatedSofCurves != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 199); } while (0); FAS_InfiniteLoop(); } } while (0);
...
static void SOF_CalculateTemperatureBasedCurrentLimit(
    ...
    const SOF_CONFIG_s *pConfigLimitValues,
    SOF_CURVE_s *pCalculatedSofCurves) {
    do { if (!(pAllowedTemperatureBasedCurrent != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 242); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pConfigLimitValues != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 243); } while (0); FAS_InfiniteLoop(); } } while (0);
    do { if (!(pCalculatedSofCurves != ((void *)(0u)))) { do { uint32_t *pc = (uint32_t *)__curpc(); FAS_StoreAssertLocation(pc, 244); } while (0); FAS_InfiniteLoop(); } } while (0);
...
extern void SOF_Calculation(void) {
    ...
    (DATA_Read1DataBlock) (&sof_tableMinimumMaximumValues);
    ...
    float_t minDischarge_mA = 3.402823466E+38F;
    float_t minCharge_mA    = 3.402823466E+38F;
    ...
    if (minCharge_mA > (float_t)(780000u)) {
        minCharge_mA = (float_t)(780000u);
    }
    if (minDischarge_mA > (float_t)(780000u)) {
        minDischarge_mA = (float_t)(780000u);
    }
    ...
    if (BMS_IsTransitionToErrorStateActive() == 1) {
        sof_tableSofValues.recommendedContinuousPackChargeCurrent_mA    = 0.0f;
        sof_tableSofValues.recommendedContinuousPackDischargeCurrent_mA = 0.0f;
        sof_tableSofValues.recommendedPeakPackChargeCurrent_mA          = 0.0f;
        sof_tableSofValues.recommendedPeakPackDischargeCurrent_mA       = 0.0f;
    ...
    (DATA_Write1DataBlock) (&sof_tableSofValues);
}
